...
/// "ScheduleFId","ReportId","CommitteeContactId","FirstName","MiddleName","LastOrCompanyName","Prefix","Suffix","AddressLine1","AddressLine2","City","StateCode","ZipCode",
/// "IsIndividual","TransactionDate","Amount","PurposeOfObligation","ScheduleId","ReportUID"
/// </summary>
public class ScheduleF
{
    public int ScheduleFId { get; set; }
    ...
    public string? PurposeOfObligation { get; set; }
